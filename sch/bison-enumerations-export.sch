...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2"
    ...
    <sch:pattern id="CompositeFrame-Codespace">
        <sch:rule context="ntx:CompositeFrame[ntx:TypeOfFrameRef/@ref='NL:BISON:TypeOfFrame:NL_BISON_ENUMS']/ntx:codespaces">
    ...
    <sch:pattern id="TypeOfEquipment">
        ...
        <sch:rule context="ntx:GeneralFrame[ntx:TypeOfFrameRef/@ref='NL:BISON:TypeOfFrame:NL_TypeOfEquipmentValues']/ntx:members/ntx:ValueSet/ntx:values/ntx:TypeOfEquipment">
    ...
    <sch:pattern id="TypeOfActivation">
    ...
    <sch:pattern id="TypeOfResponsibilityRole">
        ...
        <sch:rule context="ntx:GeneralFrame[ntx:TypeOfFrameRef/@ref='NL:BISON:TypeOfFrame:NL_TechnicalEnumerations']/ntx:members/ntx:ValueSet/ntx:values/ntx:TypeOfEntity">
            <sch:assert test="ntx:Name">Name is verplicht</sch:assert>
            <sch:assert test=".[matches(@id, '^NL:BISON:DisplayTextLength:.*$')]">TypeOfEntity moet een id van de vorm 'NL:BISON:DisplayTextLength:[UniqueValue]' hebben</sch:assert>
            <sch:assert test="@version='any'">Attribuut version moet de waarde 'any' hebben</sch:assert>
        </sch:rule>
