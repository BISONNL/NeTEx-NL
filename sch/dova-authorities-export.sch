...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2"
    ...
    <sch:pattern id="CompositeFrame-frames">
        <sch:rule context="ntx:CompositeFrame[ntx:TypeOfFrameRef/@ref='NL:BISON:TypeOfFrame:NL_DOVA_LISTS']/ntx:frames">
            <sch:assert test=".[count(ntx:GeneralFrame/ntx:TypeOfFrameRef[@ref='NL:BISON:TypeOfFrame:NL_AuthorityList'])=1]">Er moet exact 1 GeneralFrame (van type 'NL:BISON:TypeOfFrame:NL_AuthorityList') worden geleverd als onderdeel van de BISON enumerations export</sch:assert>
        </sch:rule>
    </sch:pattern>

    <sch:pattern id="Authority">
        <sch:rule context="ntx:GeneralFrame[ntx:TypeOfFrameRef/@ref='NL:BISON:TypeOfFrame:NL_AuthorityList']">
            ...
            <sch:assert test="ntx:members/ntx:Authority">members/ValueSet/values/Authority is verplicht</sch:assert>
        </sch:rule>
